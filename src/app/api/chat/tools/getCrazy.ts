...
export const getCrazy = tool({
  ...
  execute: async () => {
    return `
The craziest thing I've done? Spent 36 hours straight debugging a LangGraph agent that kept routing EVERY query — PDFs, simple questions, even "hello" — straight to the web search tool. 😂
...
Shipped it to production at 2AM, and stared at the ceiling for a while. 🤖🔥
